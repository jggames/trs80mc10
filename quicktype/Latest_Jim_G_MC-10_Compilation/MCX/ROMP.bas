...
10 ON1-(N<L)GOTO48:A=X:B=Y:ONK(PEEK(K)ANDPEEK(2))GOSUB1,2,3,4:ONK(PEEK(S(X,Y)))GOTO5,6,7,6,25
...
22 Q=0:R=1:GOTO18
23 Q=0:R=-1:GOTO18
25 POKES(A,B),E:GOSUB27:GOTO30
26 POKES(X,Y),D(1-C,1-Q):C=-C:RETURN
27 POKES(X,Y),P(1-C):RETURN
...
30 GOSUB26:SOUND1,1:SOUND10,1:GOSUB26:SOUND2,1:SOUND10,1:GOSUB26:SOUND3,1:SOUND10,1:GOSUB26:SOUND4,1:SOUND10,1:GOSUB26:SOUND5,1
31 IFS>HSTHENPRINT@14,"A NEW HIGH SCORE!";
32 PRINT@480," GO FOR ANOTHER ROMP? (Y/N)";
...
80 FORT=1TO18:POKEMC+64+RND(447),W:NEXT
85 Y=1+RND(13):X=1+RND(29):ON1-(PEEK(S(X,Y))=46)GOTO85:POKES(X,Y),47:FORT=1TOL
...
105 FORX=112TO121:K(X)=2:NEXT:X=RND(-(PEEK(9)*256+PEEK(10)))
110 FORY=0TO15:FORX=0TO31:S(X,Y)=32*Y+X+MC:NEXT:NEXT:E=32:F=32:P(0)=24:P(2)=25
120 D(2,2)=61:D(2,0)=61:D(0,2)=62:D(0,0)=60:D(2,1)=61:D(0,1)=62:K=383:H$="JIM":HS=500:GOSUB240
150 L=9:S=0:C=1:GOSUB300:GOSUB240:GOTO50
180 CLS0:PRINT@32*2+9,"aÀrompÀinÀthe";:PRINT@32*4+7,"ÎÌÀÆÉÀÎÉÀÎÉÀÎÌÀÎÉ";
190 PRINT@32*5+7,"Š€‹‡€‹†€Š…€Žˆ€Š…";:PRINT@32*6+7,"»·°ºµ°º¹°»¶°»³°ºµ";:RETURN
200 GOSUB180:PRINT@256,"PORTED FROM THE GAME "CHR$(34)"GARDEN"CHR$(34):PRINT"BY VENTZISLAV TZVETKOV. BASED"
210 PRINT"ON THE GAME "CHR$(34)"HAPPENING IN THE":PRINT"GARDEN"CHR$(34)" CREATED FOR THE PRAVETZ-";
...
240 PRINT@480+11,"HIT A KEY";:REM"hitÀaÀkey";
250 IFINKEY$=""THEN250
260 RETURN
