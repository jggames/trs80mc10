...
440 CLSSK:PRINT@0,K$;"-";TEM$;STR$(Y);TAB(17);LEFT$(STR$(ABS(LL)),5);LL$;"  ";R$;":";RIGHT$(T$,2)
...
651 IF Z<>128 AND Z<>175 AND Z<>172 THEN PR=PR-1:IFPR>1THEN650
652 IF PR<2 THEN PR=2
660 IF PC>4 AND PC<37 THEN PRINT@(32*(PR-1))+((PC-4)-1),CHR$(PP(X));
670 NEXTX:FL=0:GOTO1810
675 QQ$="MERCUR"+CHR$(PP(1))+"  "+CHR$(PP(2))+"ENUS   "+CHR$(PP(3))+"ARS   "+CHR$(PP(4))+"UPITER ":ROW=13:COL=0:GOSUB120
680 QQ$=CHR$(PP(5))+"ATURN   "+CHR$(PP(6))+"RANUS  "+CHR$(159)+"SUN  )o(MOON  ":ROW=14:GOSUB120
681 QQ$="nEW MOON + SUN   (H)ORIZON HELP,":ROW=15:GOSUB120:POKE16823,41:POKE16825,40
690 IF B$<>"" THEN QQ$=B$:ROW=12:COL=9:GOSUB120
700 QQ$="NEW (T)IME,(P)TABL,(D)ATE,(L)AT":ROW=16:COL=0:GOSUB120:POKE16895,110:RETURN
...
1040 CLS:PRINTK$;"-";TEM$;Y;TAB(19);LEFT$(STR$(ABS(LL)),5);LL$:PRINT"--------------------------"
...
1140 PRINT"(P)LANET TABLE OR NEW (D)ATE";:FL=-1:GOTO1810
1150 CLS:PRINTTAB(6);"** PLANET TABLE **":PRINT K$;"-- ";TEM$;Y;TAB(20);LEFT$(STR$(ABS(LL)),5);LL$:S1=1
...
1320 PRINT:PRINTTAB(3);"DAY'S (S)KY   NEW (D)ATE";:FL=-1:GOTO1810
...
1660 GOTO1630
1670 QQ$="*":RETURN
1680 PRINT@(32*2),K$;"-- ";TEM$;Y;TAB(20);LEFT$(STR$(ABS(LL)),5);LL$:RETURN
...
1855 IF (I$=" " OR I$="M" OR I$=CHR$(13)) AND NOTFL THENGOSUB675
