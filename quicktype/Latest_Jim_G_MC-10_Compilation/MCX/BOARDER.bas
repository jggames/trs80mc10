0 GOSUB5500:CLEAR6000,36762:DIM S1$(6),S2$(6),B$(4),N$(10),B$,BL$,T$,I$
...
5023 IF PEEK(65498)=69 THEN PK=PK-16640:POKE &HFA73,V2:GOTO 5040
5024 POKE 17033,143:POKE 17034,154:POKE 17032,126
...
6095 IF PEEK(65498)=69 THEN POKE &HFA73,96
6100 END
