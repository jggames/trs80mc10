...
33 RR=RND(3):ON1-(RR<>2)GOTO33:B$=BP$(RR)
...
307 IFI$="G"THENGOSUB400:GOSUB6100:GOSUB650:GOSUB7130:GOSUB6000:GOSUB8030:GOSUB8040:GN=0:GOSUB320:GOTO90
...
630 NEXT:NEXT
640 RETURN
650 FORY=1TO9:FORX=1TO9:IFGR$(X,Y)=""ORGR$(X,Y)=" "THENX=9:NEXT:Y=9:NEXT:GOTO680
660 NEXT:GOSUB6110:GOSUB6000:PRINT"USE EXISTING GRID (Y/N)?";
670 I$=INKEY$:ON1-(I$<>"")GOTO670:ON1-(I$<>"N")GOTO680:GOTO690
680 GOSUB4000
690 GOSUB6000:GOSUB6110:RETURN
...
2720 SJ=0:FORY=1TO9:FORX=1TO9:IFLEN(RG$(X,Y))>1THENSJ=1:TM=X:X=9:NEXT:X=TM:TM=Y:Y=9:NEXT:Y=TM:RETURN
2730 NEXT:NEXT
2740 PRINT@32*14,"* ILLOGICAL GRID *":FORY=1TO9:FORX=1TO9:GR$(X,Y)=" ":GOSUB400:NEXT:NEXT:RETURN
...
7100 IFAF=1THEN7120
7105 GOSUB6110:PRINT@15*32,"PRESS ANY KEY TO CONTINUE";
...
8190 NEXT:NEXT:GOSUB6110:RETURN
