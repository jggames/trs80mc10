0 DIMF(8,8),M,X,Y:M=RND(-(PEEK(9)*256+PEEK(10))):M=16384:GOTO200
1 RETURN
...
420 T=T-0.1:IFINT(T)<=0THENPRINT@116,"TIME:   0 ":GOTO1340
460 IFSU=64ORSU=128THEN500
470 PRINT@116,"TIME: ";INT(T):PRINT@180,"PIKES: ";P:GOTO350
500 IFSU=64THENPRINT@240,"BOARD CLEARED ON";:PRINT@272,"THE SIDE OF GOOD";:BA=BA-1:GOSUB6000:SU=0:X=1:Y=1:GOTO530
510 IFSU=128THENPRINT@240,"BOARD CLEARED ON";:PRINT@272,"THE SIDE OF EVIL";:BA=BA+1:GOSUB6000:SU=0:X=1:Y=1:GOTO530
530 IFDI=1THENT=200
540 IFDI=2THENT=300
550 IFDI=3THENT=400
...
700 IFD=3THENY=Y-1
710 IFD=4THENY=Y+1
720 POKEM+(2*(X-1))+(32*(2*(Y-1))),206:POKEM+(2*(X-1)+1)+(32*(2*(Y-1))),205:POKEM+(2*(X-1))+(32*(2*(Y-1)+1)),203
730 POKEM+(2*(X-1)+1)+(32*(2*(Y-1)+1)),199:RETURN
740 REMCAMBIO
750 REMRUTCAMBIO
...
1210 NEXTN
1220 CLS:PRINT@16,"KNIGHTS & DEMONS";:GOSUB6000
1260 FORR=1TO8
1270 FORC=1TO8
...
2000 POKEM+(2*(C-1))+(32*(2*(R-1))),149:POKEM+(2*(C-1)+1)+(32*(2*(R-1))),154:POKEM+(2*(C-1))+(32*(2*(R-1)+1)),223
2003 POKEM+(2*(C-1)+1)+(32*(2*(R-1)+1)),175:RETURN
2050 POKEM+(2*(C-1))+(32*(2*(R-1))),233:POKEM+(2*(C-1))+(32*(2*(R-1)+1)),239:POKEM+(2*(C-1)+1)+(32*(2*(R-1))),182
2053 POKEM+(2*(C-1)+1)+(32*(2*(R-1)+1)),191:RETURN
2100 POKEM+(2*(X-1))+(32*(2*(Y-1))),149:POKEM+(2*(X-1)+1)+(32*(2*(Y-1))),154:POKEM+(2*(X-1))+(32*(2*(Y-1)+1)),223
2103 POKEM+(2*(X-1)+1)+(32*(2*(Y-1)+1)),175:RETURN
2150 POKEM+(2*(X-1))+(32*(2*(Y-1))),233:POKEM+(2*(X-1)+1)+(32*(2*(Y-1))),182:POKEM+(2*(X-1))+(32*(2*(Y-1)+1)),239
2153 POKEM+(2*(X-1)+1)+(32*(2*(Y-1)+1)),191:RETURN
2400 POKEM+(2*(X-1))+(32*(2*(Y-1)-2)),149:POKEM+(2*(X-1)+1)+(32*(2*(Y-1)-2)),154:POKEM+(2*(X-1))+(32*(2*(Y-1)-1)),223
2403 POKEM+(2*(X-1)+1)+(32*(2*(Y-1)-1)),175:RETURN
2450 POKEM+(2*(X-1))+(32*(2*(Y-1)-2)),233:POKEM+(2*(X-1)+1)+(32*(2*(Y-1)-2)),182:POKEM+(2*(X-1))+(32*(2*(Y-1)-1)),239
2453 POKEM+(2*(X-1)+1)+(32*(2*(Y-1)-1)),191:RETURN
2500 POKEM+(2*(X-1))+(32*(2*(Y-1)+2)),149:POKEM+(2*(X-1)+1)+(32*(2*(Y-1)+2)),154:POKEM+(2*(X-1))+(32*(2*(Y-1)+3)),223
2503 POKEM+(2*(X-1)+1)+(32*(2*(Y-1)+3)),175:RETURN
2550 POKEM+(2*(X-1))+(32*(2*(Y-1)+2)),233:POKEM+(2*(X-1)+1)+(32*(2*(Y-1)+2)),182:POKEM+(2*(X-1))+(32*(2*(Y-1)+3)),239
2553 POKEM+(2*(X-1)+1)+(32*(2*(Y-1)+3)),191:RETURN
2600 POKEM+(2*(X-1)-2)+(32*(2*(Y-1))),149:POKEM+((2*(X-1)-2)+1)+(32*(2*(Y-1))),154
2602 POKEM+(2*(X-1)-2)+(32*(2*(Y-1)+1)),223:POKEM+((2*(X-1)-2)+1)+(32*(2*(Y-1)+1)),175:RETURN
2650 POKEM+(2*(X-1)-2)+(32*(2*(Y-1))),233:POKEM+((2*(X-1)-2)+1)+(32*(2*(Y-1))),182
2656 POKEM+(2*(X-1)-2)+(32*(2*(Y-1)+1)),239:POKEM+((2*(X-1)-2)+1)+(32*(2*(Y-1)+1)),191:RETURN
2700 POKEM+(2*(X-1)+2)+(32*(2*(Y-1))),149:POKEM+((2*(X-1)+2)+1)+(32*(2*(Y-1))),154
2702 POKEM+(2*(X-1)+2)+(32*(2*(Y-1)+1)),223:POKEM+((2*(X-1)+2)+1)+(32*(2*(Y-1)+1)),175:RETURN
2750 POKEM+(2*(X-1)+2)+(32*(2*(Y-1))),233:POKEM+((2*(X-1)+2)+1)+(32*(2*(Y-1))),182
2752 POKEM+(2*(X-1)+2)+(32*(2*(Y-1)+1)),239:POKEM+((2*(X-1)+2)+1)+(32*(2*(Y-1)+1)),191:RETURN
3000 CLS
...
3070 PRINT"VICE VERSA. YOU MAY ALSO USE THE";
...
5020 RETURN
6000 PRINT@340,"BOARDS TO":PRINT@372,"COMPLETE:":IFBA>10THENPRINT@439,20-BA:RETURN
6010 PRINT@439,BA:RETURN
