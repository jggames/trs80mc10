...
20 FORZ=1TOE:ONK(PEEK(2)ANDPEEK(383))GOSUB25,2,14,8,54,57,58,59,61,33,55:A=RND(J):GOSUB18
...
42 IFLF=0THEN80
43 X=88:Y=89:P=OS:B=143:POKEP,X:GOSUB310:GOTO20
...
60 C2=(PEEK(384)AND1)*256+PEEK(385):PRINTN;:N$=STR$(N):R=LEN(N$):FORC1=M+C2TOM+C2+R:POKEC1,PEEK(C1)-64:NEXT:RETURN
...
84 GOTO81
85 IFSC>HSTHENHS=SC
86 GOSUB5020:PRINT@267-32,"LAST:";SC:PRINT@267+32,"HIGH:";HS:GOSUB5200
90 O=1:DR=2:LF=3:P=M+16:LV=1:PL=0:SC=0:F=143:S1=0
...
160 NEXT:GOSUB330:SC=SC+(1000*DL):GOSUB70:POKEP,88:PRINT@263,"YOU ESCAPED ALIVE!";
...
255 IF(LV=3ANDS1=0)OR(LV=7ANDS1=1)THENR=RND(448):ON1-(PEEK(M+R)=143ANDPEEK(M+R+32)=175)GOTO255:PRINT@R,"@";:S1=S1+1
260 FORT=1TO4
...
2180 FORT=48TO58:K(T)=11:NEXT:K(19)=11:K(3)=11:K(15)=11:K(18)=11:K(5)=11:K(24)=11:K(4)=11:K(7)=11
3000 K(87)=1:K(65)=2:K(32)=3:K(83)=4:K(95)=5:K(90)=6:K(68)=9:K(82)=10:K(71)=11
3005 K(143)=1:K(191)=10:K(175)=11:K(88)=3:K(106)=4:K(95)=5:K(31)=6:K(43)=7:K(86)=8:K(64)=9
3006 K(46)=8:K(44)=7:K(76)=5:K(81)=7:K(69)=8
3007 K(94)=1:K(8)=2:K(9)=4:K(95)=5:K(10)=6:K(21)=7:K(93)=8:K(68)=9:K(82)=10:K(71)=11
...
3050 T=RND(1000):ON1-(INKEY$="")GOTO4020,3050
4020 GOSUB5020
...
5100 SOUND28,2:POKEP,88:SOUND79.5,2:POKEP,143:SOUND147,2:SOUND147,8:POKEP,88:SOUND79.5,2
5105 POKEP,88:SOUND147,2:POKEP,143:SOUND133,2:POKEP,88:SOUND133,8:POKEP,143:SOUND159,8
5110 POKEP,88:SOUND133,8:POKEP,143:SOUND89,8:POKEP,88:SOUND28,8:RETURN
