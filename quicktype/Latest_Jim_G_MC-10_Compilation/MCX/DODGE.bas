...
7 PRINT@P,F$;:PRINT@Q,J$;:NEXT:NEXT:GOTO20
8 IFP-64>224THENPRINT@P,C$;:PRINT@Q,C$;:P=P-64:Q=Q-64:O=0
9 PRINT@P,F$;:PRINT@Q,J$;:NEXT:NEXT:GOTO20
10 IFO<>64THENNEXT:NEXT:GOTO20
11 PRINT@P,F$;:PRINT@Q,J$;:PRINT@Q+32,"žš";:PRINT@Q+64,"©¨";:PRINT@Q+96,"¤";:SOUND100,1:PRINT@Q+32,C$;:PRINT@Q+64,"žš";:PRINT@Q+96,"©¨";:PRINT@Q+128,"Ü";
...
24 FORZ=1TO3:FORT=1TO100:S=S+L:PRINT@0,S;:IFPEEK(Q+M+V)<>DORPEEK(Q+M+A)<>DORPEEK(Q+M+B)<>DTHEN60
25 PRINT@G,E$(A(T))E$(B(T))E$(C(T))E$(D(T))E$(E(T))E$(F(T))E$(G(T))E$(H(T))E$(I(T))E$(J(T))B$D$(A(T))D$(B(T))D$(C(T))D$(D(T));
26 PRINTD$(E(T))D$(F(T))D$(G(T))D$(H(T))D$(I(T))D$(J(T))B$C$(A(T))C$(B(T))C$(C(T))C$(D(T))C$(E(T))C$(F(T))C$(G(T))C$(H(T))C$(I(T));
27 PRINTC$(J(T))B$B$(A(T))B$(B(T))B$(C(T))B$(D(T))B$(E(T))B$(F(T))B$(G(T))B$(H(T))B$(I(T))B$(J(T))B$A$(A(T))A$(B(T))A$(C(T));
29 PRINTA$(D(T))A$(E(T))A$(F(T))A$(G(T))A$(H(T))A$(I(T))A$(J(T));:ONK(PEEK(383)ANDPEEK(2))GOTO2,4,6,8,10:PRINT@P,F$;:PRINT@Q,J$;:NEXT:NEXT
30 GOTO20
60 PRINT@12,"CRASH!";
...
910 DIMK(255),P,G,Q,S,M,A,B,V,Z,F$,G$,H$,J$,K$,L$,B$,C$,L,C,O,D,HS,I$,LV:T=RND(-(PEEK(9)*256+PEEK(10))):GOTO1000
1000 G=289:P=237:Q=P+32:C=64:K(65)=1:K(83)=2:K(90)=3:K(87)=4:K(32)=5:D=128:M=16384:A=33:B=34:V=32
