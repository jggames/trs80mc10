...
4 IFC(H,T)>OTHENPRINT@O,"COLLISION!";:SOUND100,1:X=O:Y=O:J=J+10:IFJ>100THENGOSUB10
5 RETURN
6 C=-F:RETURN
7 C=F:RETURN
8 D=-F:RETURN
...
20 FORM=1TO190:G=G*-I:X=C:Y=D:PRINT@O,R$(G+I)B$R$(G+I);
22 ONPOINT(C(I,T)+X,C(W,T)+Y)GOSUB1,1,1,1,5:ONPOINT(C(I,T)+X+H,C(W,T)+Y)GOSUB1,1,1,1,5
...
110 IFM=191THENGOSUB300:SOUND50,15
...
4010 S(1)=2:S(2)=4
4020 K(65)=1:K(83)=2:K(87)=3:K(90)=4:K(13)=5:K=383
