0 CLS:DIM A(50),B(15),CA$(3,3),C1$(13),CN(10),E(10),MC,Z,FL,F
1 MC=16384:GOSUB10000:GOTO40
5 P1=(PEEK(384)AND1)*256+PEEK(385):POKEMC+P1-1,PEEK(MC+P1-1)-64:RETURN
6 PRINTCHR$(8);C1$(CN(F));:GOSUB5:RETURN
10 PRINTCA$(E(N),1);CA$(E(N+1),1);CA$(E(N+2),1);CA$(E(N+3),1);CA$(E(N+4),1)
11 PRINTCA$(E(N),2);CA$(E(N+1),2);CA$(E(N+2),2);CA$(E(N+3),2);CA$(E(N+4),2)
12 PRINTCA$(E(N),3);:F=N:GOSUB6:PRINTCA$(E(N+1),3);:F=N+1:GOSUB6:PRINTCA$(E(N+2),3);:F=N+2:GOSUB6
13 PRINTCA$(E(N+3),3);:F=N+3:GOSUB6:PRINTCA$(E(N+4),3);:F=N+4:GOSUB6
14 PRINT:IFFL=1THENFORF=NTON+4:PRINT" ";F;:NEXTF:PRINT
15 RETURN
40 PRINT "WELCOME TO THE CASINO.  WE EACH"
50 PRINT "HAVE $200.  I WILL OPEN THE":PRINT"BETTING BEFORE THE DRAW; YOU"
60 PRINT "OPEN AFTER.  TO FOLD BET 0;":PRINT"TO CHECK BET .5.  ENOUGH TALK--"
70 PRINT "LET'S GET DOWN TO BUSINESS.":PRINT:PRINT" PRESS ANY KEY TO CUT THE DECK."
80 I$=INKEY$:F=RND(1000):IFI$=""THEN80
90 O=1
100 C=200
110 S=200
120 P=0
...
160 PRINT "THE ANTE IS $5. I WILL DEAL...":OP=1
170 PRINT
180 IF S>5 THEN 200
190 GOSUB 3830
200 P=P+10
...
310 GOSUB 2170
330 IF I<>6 THEN 470
340 IF RND(10)-1<=7 THEN 370
350 X=11100
360 GOTO 420
370 IF RND(10)-1<=7 THEN 400
380 X=11110
390 GOTO 420
400 IF RND(10)-1>=1 THEN 450
410 X=11111
420 I=7
430 Z=23
440 GOTO 580
...
480 IF RND(10)-1>=2 THEN 500
490 GOTO 420
500 Z=0
510 K=0
520 PRINT "I CHECK.":OP=0
530 GOTO 620
540 IF U<=16 THEN 570
550 Z=2
560 IF RND(10)-1>=1 THEN 580
570 Z=35
580 V=Z+RND(10)-1
590 GOSUB 3480
600 PRINT "I'LL OPEN WITH $";V:OP=0
610 K=V
620 GOSUB 3050
630 GOSUB 650
640 GOTO 820
...
670 PRINT "I WIN."
680 C=C+P
690 PRINT "I HAVE $";STR$(C);", YOU HAVE $";STR$(S)
700 PRINT "DO YOU WISH TO CONTINUE";
710 INPUT H$
720 IF H$=""OR H$="YES" OR H$="Y" THEN 120
730 IF H$="NO" OR H$="N" THEN 4100
750 GOTO 700
760 IF I<>4 THEN 810
780 PRINT "YOU WIN."
790 S=S+P
...
810 RETURN
820 REM
830 PRINT"HOW MANY CARDS DO YOU WANT";
840 INPUT T
850 IF T=0 THEN 980
860 Z=10
870 IF T<4 THEN 900
880 PRINT "YOU CAN'T DRAW MORE THAN 3."
890 GOTO 840
...
1230 Z=2
1240 IF RND(10)-1<>6 THEN 1260
1250 Z=19
1260 GOTO 1330
1270 IF U>=16 THEN 1320
1280 Z=19
1290 IF RND(10)-1<>8 THEN 1310
1300 Z=11
1310 GOTO 1330
1320 Z=2
1330 K=0
...
1662 IF M-100*INT(M/100)<D-100*INT(D/100)THEN 780
1664 IF M-100*INT(M/100)>D-100*INT(D/100)THEN 670
1670 PRINT "THE HAND IS A DRAW."
1680 PRINT "ALL $";P;"REMAINS IN THE POT."
1681 INPUT"DO YOU WISH TO CONTINUE";H$
1683 IF H$=""OR H$="YES" OR H$="Y" THEN 140
1684 IF H$="NO" OR H$="N" THEN 4100
1690 GOTO1681
1700 IF M-100*INT(X/100)>D-100*INT(D/100)THEN 670
1710 IF D-100*INT(D/100)>M-100*INT(M/100)THEN 780
1720 GOTO 1670
1730 Z=Z+1
1740 A(Z)=100*INT(4*RND(0))+INT(100*RND(0))
...
1840 RETURN
1850 FOR Z=N TO N+4
1860 K=A(Z)-100*INT(A(Z)/100):CN(Z)=K
1890 K=INT(A(Z)/100):E(Z)=K
1920 NEXT Z
1930 GOSUB10
1940 RETURN
1950 K=A(Z)-100*INT(A(Z)/100)
...
2730 IF D-100*INT(D/100)>6 THEN 2750
2740 I=6
2750 RETURN
...
3360 IFOP=0THENPRINT "I'LL SEE YOU."
3370 K=G
3380 S=S-G
3390 C=C-K
3400 P=P+G+K
...
3720 GOSUB 2080
3740 RETURN
3750 K=K-100*INT(K/100)
3760 GOSUB 1960
3770 IF H$="SCHMAL" THEN 3790
3780 IF H$<>"A STRA" THEN 3810
3790 PRINT " HIGH"
3800 RETURN
3810 IF H$="TWO P" OR H$="A FULL" THEN PRINT "S":PRINT"HIGH":GOTO3820
3815 PRINT "S"
3820 RETURN
3830 PRINT
...
4100 END
10000 B$=" "
10001 CA$(1,1)=B$+CHR$(129+48)+CHR$(139+48)+CHR$(128+48)
10002 CA$(1,2)=B$+CHR$(141+48)+CHR$(143+48)+CHR$(136+48)
10003 CA$(1,3)=B$+CHR$(128+48)+CHR$(136+48)+CHR$(128+48)
10010 CA$(2,1)=B$+CHR$(135+48)+CHR$(135+48)+CHR$(130+48)
10011 CA$(2,2)=B$+CHR$(141+48)+CHR$(143+48)+CHR$(136+48)
10012 CA$(2,3)=B$+CHR$(128+48)+CHR$(136+48)+CHR$(128+48)
10020 CA$(3,1)=B$+CHR$(129+32)+CHR$(139+32)+CHR$(128+32)
10021 CA$(3,2)=B$+CHR$(143+32)+CHR$(143+32)+CHR$(138+32)
10022 CA$(3,3)=B$+CHR$(128+32)+CHR$(136+32)+CHR$(128+32)
10030 CA$(0,1)=B$+CHR$(133+32)+CHR$(143+32)+CHR$(128+32)
10031 CA$(0,2)=B$+CHR$(143+32)+CHR$(143+32)+CHR$(138+32)
10032 CA$(0,3)=B$+CHR$(128+32)+CHR$(136+32)+CHR$(128+32)
10040 C1$(0)="2":C1$(1)="3":C1$(2)="4":C1$(3)="5":C1$(4)="6":C1$(5)="7":C1$(6)="8":C1$(7)="9":C1$(8)="T":C1$(9)="J"
10045 C1$(10)="Q":C1$(11)="K":C1$(12)="A"
10050 RETURN
