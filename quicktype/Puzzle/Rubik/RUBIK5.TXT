...
520 GOTO1320
530 CLS0:PRINT@64,"SIMULATION OF";
531 PRINT@363,"bACK";    
532 PRINT@384,"uNDER lEFT tOP rIGHT";
533 PRINT@427,"fRONT";
...
1561 GOTO1570
1565 M(M5)=M(M5)+1:IFM(M5)>9THEN1590
1566 GOTO1580
1570 NEXTM5:M4=M4+1:IFM4>6THEN1590
...
1670 FORQ=1TO6:IFA$(Q)=A1$(X,Y,Z)THENQQ(X,Y,Z)=Q:GOTO1690
1680 NEXTQ:GOTO1590
1690 NEXTZ,Y,X
...
3910 FORX=1TO39STEP2:IFQ1(X)<>XTHENIFQ1(X+1)<>1THEN3915
3911 NEXTX:GOTO3920
3915 PRINT"ERROR";
...
5200 FORL=1TOJ2:ONJGOSUB770,850,930:NEXTL:GOTO5220
5210 NEXTJ1:RETURN
5220 GOSUB630
...
5361 GOTO5370
5365 GOSUB5400:B=9:GOSUB2480:B=17:GOSUB2480:B=11:GOSUB2480:B=2:GOSUB2480:B=16:GOSUB2480:B=0:GOSUB2480:GOTO5320
5370 B=15:GOSUB2480
...
5520 NEXTF
5530 FORF=1TO4:IFC1(F)=0THEN5540
5531 NEXTF:RETURN
5540 FORF=1TO4:IFQ1(37)=27ANDQ1(38)=2THEN5545
5541 GOTO5550
5545 B=3:GOSUB2480:B=17:GOSUB2480:B=5:GOSUB2480:B=17:GOSUB2480:B=11:GOSUB2480:B=15:GOSUB2480:B=9:GOSUB2480:C1(2)=1:GOTO5530
5550 IFQ1(39)=27ANDQ1(40)=1THENGOSUB6020:C1(2)=1:GOTO5530
5560 IFQ1(39)=29ANDQ1(40)=1THEN5565
5561 GOTO5570
5565 B=9:GOSUB2480:B=17:GOSUB2480:B=11:GOSUB2480:B=17:GOSUB2480:B=2:GOSUB2480:B=15:GOSUB2480:B=0:GOSUB2480:C1(3)=1:GOTO5530
5570 IFQ1(33)=29ANDQ1(34)=2THENGOSUB6030:C1(3)=1:GOTO5530
5580 IFQ1(33)=31ANDQ1(34)=2THEN5585
5581 GOTO5590
5585 B=0:GOSUB2480:B=17:GOSUB2480:B=2:GOSUB2480:B=17:GOSUB2480:B=8:GOSUB2480:B=15:GOSUB2480:B=6:GOSUB2480:C1(4)=1:GOTO5530
5590 IFQ1(35)=31ANDQ1(36)=1THENGOSUB6040:C1(4)=1:GOTO5530
5600 IFQ1(35)=25ANDQ1(36)=1THEN5605
5601 GOTO5610
5605 B=6:GOSUB2480:B=17:GOSUB2480:B=8:GOSUB2480:B=17:GOSUB2480:B=5:GOSUB2480:B=15:GOSUB2480:B=3:GOSUB2480:C1(1)=1:GOTO5530
5610 IFQ1(37)=25ANDQ1(38)=2THENGOSUB6010:C1(1)=1:GOTO5530
5620 B=15:GOSUB2480:NEXTF
5630 FORF=1TO4:IFC1(F)=0THEN5650
5640 NEXTF
...
5700 FORF=10TO14STEP2:IFQ1(F)<>1THEN5710
5701 NEXTF:RETURN
5710 FORF=2TO3:IF((Q1(10)=F)+(Q1(12)=F)+(Q1(14)=F)+(Q1(16)=F))=-3THEN5800
5711 NEXTF
5720 FORF=1TO4:IF((Q1(10)=2)+(Q1(12)=2)+(Q1(14)=1)+(Q1(16)=2))=-1THEN5725
5721 GOTO5730
...
5825 STOP
5830 FORF=1TO4:IFQ1(34)=2ANDQ1(40)=2THEN6100
...
5850 FORF=1TO2:IFQ1(37)-Q1(15)=24ANDQ1(39)-Q1(13)=24THEN5855
5851 GOTO5860
...
5870 FORF=1TO4:IF(Q1(39)-Q1(15)=24)AND(Q1(37)-Q1(13)<>24)THEN6190
