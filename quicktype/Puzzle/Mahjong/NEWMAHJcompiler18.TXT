0 CLEAR1200:POKE49151,64:GOTO900
...
20 CLS:PRINT"YOUR TURTLE APPROACHES...":PRINT@172,"MAHJONG":PRINT@228,"BY CHARLIE & JIM GERRIE"
21 PRINT@258,"USING GREG DIONNE'S MCBASIC":GOSUB5500
...
80 K=0:M$=INKEY$:IFM$<>""THENK=ASC(M$)
81 RETURN
...
89 CLS:C=53:FORT=1TO5:POKEMC+(T+10)*32+1,C+64:PRINT@(T+10)*32,MID$("ÿοίΟ",T,1);:C=C-1:NEXT
...
133 A=(L(X,Y,6)-1)*2+1
135 GOSUB6:FORT=1TO150:GOSUB80:IFKTHENT=999
140 NEXT:PRINT@C,"ΏΏ";:PRINT@C+32,"ΏΏ";:IFKTHENFORT=1TO100:NEXT:GOTO160
150 FORT=1TO70:GOSUB80:IFKTHENT=999
151 NEXT:IFK=0THEN135
160 GOSUB6
161 IFK=65THENX=X-1:GOTO84
162 IFK=68THENON-(L(X,Y,.)=5)GOSUB178:X=X+1:GOTO84
163 IFK=87THENY=Y-1:GOTO84
164 IFK=83THENON-(L(X,Y,.)=5)GOSUB179:Y=Y+1:GOTO84
165 IFK=32THEN180
...
180 IFITHEN190
181 IFZ=.THEN192
182 IFL(X,Y,Z)<3THENZ=.:GOSUB6:SOUND200-L(.,7,2),1:I=X:J=Y:GOTO130
183 GOTO192
...
210 X=Q:Y=R:I=.:J=.:SOUND200-L(.,7,2),1:L(.,7,2)=L(.,7,2)-2:GOSUB880:IFL(.,7,2)>.THEN130
220 GOSUB590
230 GOSUB710:IFI$="Y"THEN2180
250 IFI$="N"THENEND
260 GOTO230
...
282 GOSUB6:IFX=7THENIFY=4THENIFZ=4THEN289
283 RETURN
...
1020 A$(2)="ΩέÒίÒίÒέΤέΪΧΨΧΣΥΨΥΪΥΨέΠέΡΧΡέΠΧΠΧΡέΤΥÒΧέΥΤΧΥίΠΥΡέΡΥΠΥΠΥΠέΪΧÒΧΥΥΥΥΤΥΦΧΦΧÒί  "
...
1060 A$(4)="ωύςÿςÿςύτύϊχψχσυψυϊυψύπύρχρύπχπχρύτυςχύυτχυÿπυρύρυπυπυπύϊχςχυυυυτυφχφχςÿ  "
1070 B$(4)="ϋÿϋÿÿχσÿϋÿχÿσÿϋÿσÿσÿχχσχσχσÿσχχÿσχχχσχσχχχσχχχχχσχχÿÿχχχσÿϋÿσχϋÿσχχχϋÿϋχ  "
1080 A$(5)="™’’’”——“•••‘—‘——‘”•’—•”—••‘‘•••—’—••••”•–—–—’  "
1090 B$(5)="››—“›—“›““——“—“—““——“———“—“———“—————“—————“›“—›“———››—  "
...
2160 GOSUB5500:PRINT@486,"HIT ANY KEY TO BEGIN";
2170 M$=INKEY$:IFM$=""THEN2170
2180 CLS0:POKE49151,0
