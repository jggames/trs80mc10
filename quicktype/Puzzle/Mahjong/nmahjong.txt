...
1 ONABS(L(X,Y,Z))GOTO2,3,4,5:END
...
79 PRINT@26,"","JUST A LITTLE LONGER...":GOSUB3100:GOSUB80:GOTO100

80 CLS:C=53:FORT=1TO5:POKEMC+(T+10)*32+1,C+64:PRINT@(T+10)*32,MID$("ÿοίΟ",T,1);:C=C-1:NEXT
...
133 A=(L(X,Y,6)-1)*2+1
135 GOSUB6:FORT=1TO50:K=PEEK(2)ANDPEEK(V):IFKTHENT=50
140 NEXT:PRINT@C,"ΏΏ";:PRINT@C+32,"ΏΏ";:IFKTHEN160
150 FORT=1TO40:K=PEEK(2)ANDPEEK(V):IFKTHENT=40
151 NEXT:IFNOT(K)THEN135
160 GOSUB6
161 IFK=65THENIFX>1THENX=X-1:GOTO130
162 IFK=83THENIFX<15THENON-(L(X,Y,.)=5)GOSUB178:X=X+1:GOTO130
163 IFK=87THENIFY>1THENY=Y-1:GOTO130
164 IFK=90THENIFY<8THENON-(L(X,Y,.)=5)GOSUB179:Y=Y+1:GOTO130
165 IFK=32THEN180
...
900 CLS0:DIML(16,8,6),X(144),Y(144),Z(144),P(144),T(144),A$(5),B$(5),L$(5,8),T,I,J,X,Y,Z,S,A,C,K,P$(5,8),P,N,Q,R,V
910 NN=RND(-(PEEK(9)*256+PEEK(10))):P=144:N=-1:MC=16384:V=17023
...
5500 PRINT@323,"MATCH TILES OPEN ON LEFT  ";:PRINT@355,"OR RIGHT SIDE. USE W,A,S,Z";
