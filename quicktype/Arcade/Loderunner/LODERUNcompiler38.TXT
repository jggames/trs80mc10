0 CLS:GOSUB100:GOTO90
1 FORZZ=1TOZ1:NEXT:RETURN
2 RETURN
3 M=C(T):GOTO7
...
9 A=P(A(T),B(T)):B=N(T):POKEA,B:N(T)=P:A(T)=A(T)+X(M):B(T)=B(T)+Y(M):A=P(A(T),B(T)):B=D(M,T):POKEA,B:GOSUB1
...
57 IFI$="Y"THEN:LC=.:MN=5:S=0:LV=0:GOTO900
58 IFI$="N"THENCLS:GOTO70
59 GOTO56
61 GOSUB9:SOUND193,3:SOUND204,3:SOUND204,3:LC=LC+1:Z=65000:C=F:S=V:MN=MN+1:PRINT@480,"LIVES=";MN;:RETURN
65 CLS:PRINT"  mc-lode runner by jim gerrie"
66 PRINT"        and greg dionne":RETURN
70 GOSUB65:PRINT
71 PRINT"YOU COMPLETED";STR$(LC*10);"% OF THE":PRINT"SCREENS AT LEVEL";Z2:END
80 MN=1:GOTO40
82 I(U)=1:RETURN
83 M=.:IFPEEK(2)AND1ANDNOTPEEK(16949)THENM=K(68):RETURN
84 IFPEEK(2)AND1ANDNOTPEEK(16946)THENM=K(65):RETURN
85 IFPEEK(2)AND4ANDNOTPEEK(16948)THENM=K(83):RETURN
86 IFPEEK(2)AND4ANDNOTPEEK(16952)THENM=K(87):RETURN
87 IFPEEK(2)AND32ANDNOTPEEK(16949)THENM=K(44):RETURN
88 IFPEEK(2)AND32ANDNOTPEEK(16951)THENM=K(46):RETURN
89 RETURN
...
130 PRINT"    W"
140 PRINT"  A  S  D"
155 PRINT"              TO DIG USE: "
156 PRINT"                 ,  ."
160 PRINT"       FOR LEFT AND RIGHT HOLES":PRINT
180 PRINT"AFTER SCREEN IS DISPLAYED PRESS"
190 PRINT"N TO SKIP TO NEXT SCREEN. GUARDS";
195 PRINT"ONLY GIVE UP ONE GOLD WHEN THEY"
196 PRINT"FALL IN PITS. THERE ARE 10"
197 PRINT"SCREENS. ENTER=ABORT A SCREEN.":PRINT
198 PRINT@456,"";:INPUT"LEVEL (1-3)";Z2:IFZ2<1ORZ2>3THEN198
199 Z1=500-(Z2*100)
200 RETURN
800 X=RND(-(PEEK(9)*256+PEEK(10))):W2(4)=2:W2(2)=4:D=188:Q=160
805 K(44)=1:K(65)=2:K(87)=3:K(68)=4:K(83)=5:K(46)=6:MC=16384:K=17023:G=128:H=220:I=175:L=16:N=32:W(1)=4:W(2)=2
...
902 IFLV=11THENPRINT"GAME OVER.":GOTO71
904 IFMN<1THEN55
